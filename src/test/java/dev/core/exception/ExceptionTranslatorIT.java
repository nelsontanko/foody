...
/**
 * Integration tests {@link dev.core.exception.ExceptionTranslator} controller advice.
 */
@WithMockUser
...
class ExceptionTranslatorIT {
    ...
    void testConcurrencyFailure() throws Exception {
        mockMvc
                ...
                .andExpect(jsonPath("$.message").value(dev.core.exception.ErrorConstants.ERR_CONCURRENCY_FAILURE));
    }
    ...
    void testMethodArgumentNotValid() throws Exception {
        mockMvc
                ...
                .andExpect(content().contentType(MediaType.APPLICATION_PROBLEM_JSON))
                .andExpect(jsonPath("$.message").value(dev.core.exception.ErrorConstants.ERR_VALIDATION))

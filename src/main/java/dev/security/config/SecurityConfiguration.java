...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        http
            ...
            .headers(headers ->
                headers
                    .contentSecurityPolicy(csp -> csp.policyDirectives(foodyProperties.getSecurity().getContentSecurityPolicy()))
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/reset-password/init")).permitAll()
                    .requestMatchers(mvc.pattern("/api/reset-password/finish")).permitAll()
